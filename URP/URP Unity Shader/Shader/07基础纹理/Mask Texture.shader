    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                //高光：
                half4 specularMask = SAMPLE_TEXTURE2D(_SpecularMask,sampler_SpecularMask,i.uv.xy)*_SpecularScale;
                half3 halfVec = normalize(tangentViewDir+tangentLightDir);
                half3 specular = mylight.color*_SpecularColor*pow(saturate(dot(tangentNormal,halfVec)),_Gloss)*specularMask;
